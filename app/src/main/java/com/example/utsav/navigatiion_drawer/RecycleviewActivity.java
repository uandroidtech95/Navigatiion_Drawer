...
import model.DepthPageTransformer;
...
public class RecycleviewActivity extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    WhatsappFragment whatsappFragment = WhatsappFragment.newInstance("", "");
                    return whatsappFragment;
                case 1:
                    YoutubeFragment youtubeFragment = YoutubeFragment.newInstance("", "");
                    return youtubeFragment;
                case 2:
                    FlipkartFragment flipkartFragment = FlipkartFragment.newInstance("", "");
