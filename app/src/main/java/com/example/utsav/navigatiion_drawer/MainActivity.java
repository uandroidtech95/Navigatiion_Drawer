...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_signin) {
            ...
            SpeakerzenFragment speakerzenFragment = SpeakerzenFragment.newInstance("", "");
            addFragment(R.id.fragment_container, speakerzenFragment);
        } else if (id == R.id.nav_amenities) {
            AmenitiesFragment amenitiesFragment = AmenitiesFragment.newInstance("", "");
            addFragment(R.id.fragment_container, amenitiesFragment);
        } else if (id == R.id.nav_car) {
            CarFragment carFragment = CarFragment.newInstance("", "");
            addFragment(R.id.fragment_container, carFragment);
